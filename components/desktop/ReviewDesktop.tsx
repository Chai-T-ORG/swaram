...
/**
 * Review, desktop (spec D7 & §4) — read-aloud header, state-aware stat tiles,
 * large-type field rows with inline edit, and dynamic primary actions.
 */
  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-7 animate-fade-in">
      ...
      <div className="flex flex-wrap gap-3">
        {isPendingMode ? (
          <button type="button" className="btn-primary min-h-12 px-5 text-sm" onClick={r.goFill}>
      ...
      <div className="mt-2 flex items-center justify-between border-t border-line/65 pt-6">
        ...
        <button
          type="button"
          className={`${isPendingMode ? "btn-secondary" : "btn-primary"} min-h-13 px-10 text-sm`}
