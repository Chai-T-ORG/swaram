...
export default function HomeDesktop() {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl pb-16 pt-4 flex flex-col items-center">
      ...
      <div className="flex flex-col items-center w-full">
        ...
        {/* Main Solid Voice Stage - Orb sits directly on canvas */}
      ...
      {/* Recent strip (stays below the fold) */}
      {recent.length > 0 && (
        <section aria-label="Recent forms" className="w-full flex flex-col gap-3 mt-12">
